...
import com.mrn.petclinic.services.PetService;
import com.mrn.petclinic.services.PetTypeService;
...
@Service
@Profile({"default", "map"}) // come up with a profile (an active profile)
